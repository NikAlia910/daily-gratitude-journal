...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GRATITUDEENTRY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GRATITUDEENTRY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GRATITUDEENTRY actions', async () => {
      const arg = { id: 4113 };
    ...
    it('dispatches UPDATE_GRATITUDEENTRY actions', async () => {
      const arg = { id: 4113 };
    ...
    it('dispatches PARTIAL_UPDATE_GRATITUDEENTRY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GRATITUDEENTRY actions', async () => {
      const arg = 42666;
